...
type DestinationClient interface {
	...
	Get(ctx context.Context, in *GetEndpoints, opts ...grpc.CallOption) (Destination_GetClient, error)
...
func (c *destinationClient) Get(ctx context.Context, in *GetEndpoints, opts ...grpc.CallOption) (Destination_GetClient, error) {
...
type DestinationServer interface {
	// Given a destination, return all addresses in that destination as a long-
	// running stream of updates.
	Get(*GetEndpoints, Destination_GetServer) error
	// Given a destination, return that destination's profile and send an update
	// whenever it changes.
...
func (UnimplementedDestinationServer) Get(*GetEndpoints, Destination_GetServer) error {
